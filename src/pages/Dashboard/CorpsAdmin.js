...
const CorpsAdmin = () => {
	...
	return (
		<div className="flex-grow-1 px-3 ml-72 h-screen">
			...
			<h1 className="text-white">ADMINISTRATIONS</h1>
						...
						<td className="w-4 p-4">
							<div className="flex items-center">
								<input id="checkbox-table-search-2" type="checkbox"
								       className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500  dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 "/>
